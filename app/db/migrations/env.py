...
from app.core.config import settings #NOTE: Importa o sttings para pegar os dados
...
from app.db.base import Base  #NOTE: Importa o Base com os models registrados
